...
class POFPlanThinningsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table("pof_plan_thinnings")->insert([
            [
                "planThinning_id" => "rbiThinning01",
                "planThinning_componentId" => "rndComp01",
                "planThinning_corrosionRate" => 0.3172,
                "planThinning_rbiDate" => "2024-01-01",
                "planThinning_tMinInch" => 0.5096,
                "planThinning_tMinMM" => 12.943,
