    ...
    public function run(): void
    {
        ...
        DB::table("pof_plan_thinnings")->insert([
            ...
            [
                ...
                "planThinning_corrosionRate" => 0.03823529,
                "planThinning_planDate" => "2025-03-20",
                "planThinning_tMinInch" => 0.3307,
                "planThinning_tMinMM" => 8.4,
                "planThinning_nInspA" => 0,
                "planThinning_nInspB" => 1, 
                "planThinning_nInspC" => 0,
                "planThinning_nInspD" => 0,
                "planThinning_injectionPoints" => 1,
                "planThinning_deadLegs" => 1,
                "planThinning_weldingConstruction" => 1,
                "planThinning_astMaintenance" => 1,
                "planThinning_settlement" => 1,
                "planThinning_onlineMonitoring" => 1,
                "created_at" => Carbon::now(),
                "updated_at" => Carbon::now(),
            ],
            [
                ...
                "planThinning_corrosionRate" => 0.046,
                "planThinning_planDate" => "2028-03-20",
                "planThinning_tMinInch" => 0.05 ,
                "planThinning_tMinMM" => 1.27,
                "planThinning_nInspA" => 0,
                "planThinning_nInspB" => 1, 
                "planThinning_nInspC" => 0,
                "planThinning_nInspD" => 0,
