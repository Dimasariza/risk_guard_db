...
class InsertDamageMechanismDTO
{
    public function __construct(
        public readonly string $dm_id,
        public readonly string $dm_thinning,
        public readonly string $dm_comp_linning,
        public readonly string $dm_scc_caustic,
        public readonly string $dm_scc_amine,
        public readonly string $dm_scc_sulfide,
        public readonly string $dm_scc_hic_h2s,
        public readonly string $dm_scc_alkaline,
        public readonly string $dm_scc_polythionic,
        public readonly string $dm_scc_chloride,
        public readonly string $dm_scc_chloride_A,
        public readonly string $dm_scc_chloride_B,
        public readonly string $dm_scc_chloride_C,
        public readonly string $dm_scc_hydrogen,
        public readonly string $dm_scc_hic_hf,
        public readonly string $dm_exCor,
        public readonly string $dm_exCor_A,
        public readonly string $dm_exCor_B,
        public readonly string $dm_exCor_C,
        public readonly string $dm_exCor_D,
        public readonly string $dm_exCor_E,
        public readonly string $dm_exCor_F,
        public readonly string $dm_exCor_G,
        public readonly string $dm_exCor_H,
        public readonly string $dm_exCor_I,
        public readonly string $dm_cor_under_ins,
        public readonly string $dm_exChloride,
        public readonly string $dm_exChloride_A,
        public readonly string $dm_exChloride_B,
        public readonly string $dm_exChloride_C,
        public readonly string $dm_exChloride_D,
        public readonly string $dm_highTemp,
        public readonly string $dm_highTemp_A,
        public readonly string $dm_highTemp_B,
        public readonly string $dm_highTemp_C,
        public readonly string $dm_brittleFracture,
        public readonly string $dm_brittleFracture_A,
        public readonly string $dm_brittleFracture_B,
        public readonly string $dm_low_alloy_steel,
        public readonly string $dm_low_alloy_steel_A,
        public readonly string $dm_low_alloy_steel_B,
        public readonly string $dm_embrittlement,
        public readonly string $dm_embrittlement_A,
        public readonly string $dm_embrittlement_B,
        public readonly string $dm_sigma_phase,
        public readonly string $dm_sigma_phase_A,
        public readonly string $dm_sigma_phase_B,
        public readonly string $dm_piping_mechanical,
        public readonly string $dm_piping_mechanical_A,
        public readonly string $dm_piping_mechanical_B,
        public readonly string $dm_compId,
    ) {
    }
    ...
    public static function fromRequest(CreateDamageMechanismRequest $request): self
    {
        return new self(
            ...
            dm_compId: $request->validated("dm_compId"),
        );
    }
