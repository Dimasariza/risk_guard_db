...
use App\Http\Controllers\PofPlanController;
...
use App\Http\Controllers\PofRbiController;
...
use App\Http\Controllers\PolPlanController;
use App\Http\Controllers\PolRBIController;
...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::apiResource('pof_rbi', PofRbiController::class);
    Route::apiResource('pof_plan', PofPlanController::class);
    Route::apiResource('pol_rbi', PolRBIController::class);
    Route::apiResource('pol_plan', PolPlanController::class);
